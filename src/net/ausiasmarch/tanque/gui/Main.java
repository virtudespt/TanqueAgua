...
public class Main extends javax.swing.JFrame {
    ...
    private void jButtonLlenarMedioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonLlenarMedioActionPerformed
        int sequia;
        if (jTextFieldNivelSequia.getText().isEmpty()) {
            mensaje("El campo del nivel de sequía no puede estar vacío\n");
        } else if (!Convert.isValidInt(jTextFieldNivelSequia.getText())) {
            mensaje("Valor de la edad no válido\n");
        }
        sequia = Convert.parseInt(jTextFieldNivelSequia.getText());
        controlRiego.setSequia(sequia);
        //if(controlRiego.permitidoLLenar())
